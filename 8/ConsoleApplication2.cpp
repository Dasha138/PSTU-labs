...
{
    cout << "Марка: " << infof.marka << endl;;
    cout << "Серийный номер: " << infof.sernomer << endl;
    cout << "Регистрационный номер: " << infof.regnomer << endl;;
    cout << "Год выпуска: " << infof.year << endl;
    cout << endl;
}
